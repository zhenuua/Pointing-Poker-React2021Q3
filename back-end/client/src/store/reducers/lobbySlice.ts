...
const lobbySlice = createSlice({
  ...
  reducers: {
    ...
    removePendingUser(state, action) {
      const index = state.pendingUsers.findIndex((user) => user.socketId === action.payload.socketId);
    ...
    removeUser(state, action) {
      const index = state.users.findIndex((user) => user.socketId === action.payload.socketId);
    ...
    removeIssue(state, action) {
      const index = state.issues.findIndex((issue) => issue.issueId === action.payload.issueId);
